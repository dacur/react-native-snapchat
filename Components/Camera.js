        ...
        <View style={{ flex: 1 }}>
          <Camera style={{ flex: 1,justifyContent:"space-between" }} type={this.state.type}>
            ...
            >
              <View style={{flexDirection:'row', flex:4}}>
                ...
                <Item style={{backgroundColor: 'transparent'}}>
                  <Icon name="ios-search" style={{color:'white', fontSize:24, 
                    fontWeight:'bold'}}></Icon>
            ...
            <View style={{flexDirection:"row", justifyContent:"space-between",
              ...
              <MaterialCommunityIcons name="message-reply" style={{color:"white",
              fontSize:36}}>
              </MaterialCommunityIcons>
              <View style={{alignItems:'center'}}>
                <MaterialCommunityIcons name="circle-outline" style={{color:"white",
                fontSize:100}}>
                </MaterialCommunityIcons>
                <Icon name="ios-images" style={{color:"white",fontSize:36}} />              
              </View>
              <MaterialCommunityIcons name="google-circles-communities" style={{color:"white",
              fontSize:36}}>
              </MaterialCommunityIcons>
            </View>
          </Camera>
